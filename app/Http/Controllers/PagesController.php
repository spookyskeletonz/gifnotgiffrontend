...
class PagesController extends Controller
{
    ...
    public function playSimulation(Request $request){
        ...
        return view('playSimulation', ['article' => $article,'roundNumber' => $request->roundNumber, 'prediction' => $request->prediction, 'score' => $score, 'topiccode1' => $request->topiccode1, 'data' => $chartData]);
    }
